...
def upload_file():
    if request.method == 'POST':
        ...
        df = pd.read_csv(os.path.join(app.config["UPLOAD_FOLDER"], filename),header=0)
        print(df)
        ##return render_template('home/manipulating-file.html', results=data, fieldnames=filename)
