...
app.config["UPLOAD_FOLDER"] = "/mnt/c/wsl/projects/pythonise/tutorials/flask_series/app/app/static/img/uploads"
...
def upload_file():
    if request.method == 'POST':
        ...
        return render_template('home/manipulating-file.html', results=results, fieldnames=filename, len=len)
