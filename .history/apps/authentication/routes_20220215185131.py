...
def upload_file():
    return render_template('manipulating-file.html', results=null, fieldnames=null, len=len)
...
def upload_file():
    if request.method == 'POST':
        ...
        return render_template('manipulating-file.html', results=results, fieldnames=filename, len=len)
