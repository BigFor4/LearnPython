...
from flask import render_template, redirect, request, url_for,ReusableForm
...
def getListUser():
    ...
    return render_template('users/manage-user.html',form=form,users=pagination_users
...
@blueprint.route('/manage-user/delete-record',methods=["DELETE","GET"])
def deleterecord():  
    return "haha"
# endregion
